...
public class DateUtil {
     ...
     * @return
     */
    public static Date getSpecifyDateWeekStart( Date date) {
     ...
     * @return
     */
    public static Date getSpecifyDateWeekEnd( Date date) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static Date getSpecifyDateMonthStart( Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @return
     */
    public static Date getSpecifyDateMonthEnd( Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.add(Calendar.MONTH, 0);
     ...
     * @return
     */
    public static Date getSpecifyDateYearStart( Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.clear();
     ...
     * @return
     */
    public static Date getSpecifyDateYearEnd( Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.clear();
        calendar.set(Calendar.YEAR, date.getYear() + 1900);
